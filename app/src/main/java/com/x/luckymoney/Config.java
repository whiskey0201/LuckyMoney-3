...
public class Config {
    ...
    public static final String ACTION_LUCKYMONKEY_SERVICE_DISCONNECT = "com.x.luckymonkey.ACCESSBILITY_DISCONNECT" ;
    public static final String ACCTION_LUCKYMONKRY_SERVICE_CONNECT = "com.x.luckymonkey.ACCESSBILITY_CONNECT";
