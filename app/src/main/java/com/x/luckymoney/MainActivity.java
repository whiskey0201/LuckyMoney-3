...
public class MainActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LKMYApplication.activityStartMain(this);
        IntentFilter filter = new IntentFilter();
        filter.addAction(Config.ACCTION_LUCKYMONKRY_SERVICE_CONNECT);
        filter.addAction(Config.ACTION_LUCKYMONKEY_SERVICE_DISCONNECT);
    ...
    private BroadcastReceiver qhbConnectReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(Config.ACCTION_LUCKYMONKRY_SERVICE_CONNECT.equals(action)) {
                if (mTipsDialog != null) {
                    mTipsDialog.dismiss();
                }
            } else if(Config.ACTION_LUCKYMONKEY_SERVICE_DISCONNECT.equals(action)) {
        ...
        public void onCreate(Bundle saveInstanceState){
            ...
            findPreference(Config.KEY_ENABLE_WECHAT).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if ((Boolean)newValue && ! LuckyMoney.isRunning()){
